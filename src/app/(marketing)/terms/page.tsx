    ...
    <div className="min-h-screen bg-bg">
      <div className="mx-auto max-w-2xl px-4 py-12">
        ...
        <div className="prose max-w-none text-sm leading-relaxed space-y-6">
          <section>
            <h2 className="text-lg font-semibold text-text">第1条（適用）</h2>
          ...
          <section>
            <h2 className="text-lg font-semibold text-text">第2条（サービス内容）</h2>
            <p className="text-text2">
          ...
          <section>
            <h2 className="text-lg font-semibold text-text">第3条（アカウント）</h2>
            <p className="text-text2">
          ...
          <section>
            <h2 className="text-lg font-semibold text-text">第4条（料金・決済）</h2>
            <p className="text-text2">
          ...
          <section>
            <h2 className="text-lg font-semibold text-text">第5条（禁止事項）</h2>
            <p className="text-text2">
          ...
          <section>
            <h2 className="text-lg font-semibold text-text">第6条（免責事項）</h2>
            <p className="text-text2">
              本サービスは「現状有姿」で提供されます。
          ...
          <section>
            <h2 className="text-lg font-semibold text-text">第7条（規約の変更）</h2>
            <p className="text-text2">
              当方は必要に応じて本規約を変更できます。
              重要な変更はサービス内で通知します。
            </p>
